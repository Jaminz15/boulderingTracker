...
public class Auth extends HttpServlet implements PropertiesLoader {
    ...
    private String validate(TokenResponse tokenResponse, HttpServletRequest req) throws IOException {
        ...
        // Find the key that matches the "kid" from the token header
        KeysItem correctKey = null;
        ...
        session.setAttribute("userClaims", jwt.getClaims()); // Store all claims if needed
